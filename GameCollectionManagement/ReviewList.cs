...
namespace GameCollectionManagement
{
    public partial class ReviewList : UserControl
    {
        ...
        {
            var reviews = _reviewService.GetAllByRole(_user.Role, _user.Id);
            dgvReviews.DataSource = reviews;
        }

        private void btnListReviews_Click(object sender, EventArgs e)
        {
            LoadReviews();
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            if (dgvReviews.SelectedRows.Count > 0)
            {
                ...
                EditReview editReview = new EditReview(id, this);
